...
//-Constructor-------------------------------------------------------------------------------------------------
KAtlasKeyGenerator::KAtlasKeyGenerator(const Atlas& atlas, QString atlasName) : mAtlas(atlas), mAtlasName(atlasName) {}

//-Member Functions--------------------------------------------------------------------------------------------
//Private:
QMap<QString, QRectF> KAtlasKeyGenerator::translateElements()
{
...
QString KAtlasKeyGenerator::writeXml(const QMap<QString, QRectF>& kElements)
{
    // Setup Writer
    QString xmlOut;
