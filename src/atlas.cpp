...
//-Constructor-------------------------------------------------------------------------------------------------
Atlaser::Atlaser(const QMap<QString, QImage>& namedImages) : mNamedImages(namedImages) {}

//-Member Functions--------------------------------------------------------------------------------------------
//Private:
QMap<QString, QPoint> Atlaser::packMap(const QMap<QString, QSize>& boxesToPack, QSize& size) // TODO: Make a visualizer for this function
{
...
Atlas Atlaser::process()
{
    ...
    return Atlas{atlasImage, atlasElements};
}
